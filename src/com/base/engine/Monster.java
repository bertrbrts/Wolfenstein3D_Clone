...
public class Monster 
{
	...
	public static final float SIZEX = (float) ((double) SIZEY / (1.9310344827586206895511724137931 * 2));
	public static final float START = 0;

	public static final float OFFSET_X = 0f;
	public static final float OFFSET_Y = 0f;

	private static final float OFFSET_FROM_GROUND = 0.0f;
	...
	private void idleUpdate(Vector3f orientation, float distance) 
	{
		...
		else 
		{
			...
			if (canLook) 
			{
				...
				{
					System.out.println("saww player!");
					state = STATE_CHASE;
				}
